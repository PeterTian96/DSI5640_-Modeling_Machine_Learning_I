...
From the graph, the error goes down at the first and becomes higher after K=8.the highest k value should be around 1 standard deviation from k = 5. Thus the k here will be 20